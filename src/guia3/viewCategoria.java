...
public class viewCategoria extends JFrame implements ActionListener {
	private JLabel lbl_titulo;
    private JLabel lbl1, lbl2;

    private JTextField txt_codigo, txt_categoria;
    ...
    private void IniciarControles() {
        ...
        lbl2 = new JLabel();
        lbl2.setText("Categoría");
        lbl2.setBounds(10, 70, 120, 25);

        txt_categoria = new JTextField();
        txt_categoria.setBounds(130, 70, 150, 25);
    ...
    private void MostrarDatos() {
        ...
        try {
            ...
            rs = stm.executeQuery("call sp_listar_categoria()");
    ...
    private class ControladorTxt implements KeyListener {
        ...
        public void keyTyped(KeyEvent e) {
            ...
            if (e.getSource() == txt_categoria && txt_categoria.getText().length() == 20) {
                e.consume();
            }
        }
    ...
    private class ControladorClick extends MouseAdapter {
        ...
        public void mouseClicked(MouseEvent e) {
            ...
            if (registro == -1) {
                JOptionPane.showMessageDialog(null, "Categoría no Elegida");
            }
            else {
	...
	public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == btn_nuevo) {
            ...
            if (txt_categoria.getText().equals("")) {
                JOptionPane.showMessageDialog(null, "Falta ingresar categoría");
            ...
            categoria.setCodigo(txt_codigo.getText());
            ...
            try {
                ...
                if (e.getSource() == btn_agregar) {
                    ...
                    pstm.setString(1, categoria.getCodigo());
                    ...
                    sql = "update tb_categoria set categoria = ? where codigo_categoria = ?";

                    pstm = cnx.prepareStatement(sql);
                    
                    pstm.setString(1, categoria.getCategoria());
                    pstm.setString(2, categoria.getCodigo());
                    ...
                    if (opc == JOptionPane.YES_OPTION) {
                        ...
                        sql = "delete from tb_categoria where codigo_categoria = ?";
	...
	public static void main(String[] args) {
		viewCategoria cat = new viewCategoria();
		cat.setVisible(true);
	}
